...
#include "amr_msgs/msg/detail/detected_obstacle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const amr_msgs::msg::DetectedObstacle & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: reporter_id
  cdr << ros_message.reporter_id;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  amr_msgs::msg::DetectedObstacle & ros_message)
{
  // Member: reporter_id
  cdr >> ros_message.reporter_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_msgs
max_serialized_size_DetectedObstacle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_msgs::msg::DetectedObstacle;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_amr_msgs
max_serialized_size_key_DetectedObstacle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const amr_msgs::msg::DetectedObstacle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<amr_msgs::msg::DetectedObstacle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DetectedObstacle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const amr_msgs::msg::DetectedObstacle *>(
...
static size_t _DetectedObstacle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectedObstacle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DetectedObstacle__callbacks = {
  "amr_msgs::msg",
  "DetectedObstacle",
...
static rosidl_message_type_support_t _DetectedObstacle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DetectedObstacle__callbacks,
...
{
  return &amr_msgs::msg::typesupport_fastrtps_cpp::_DetectedObstacle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_msgs, msg, DetectedObstacle)() {
  return &amr_msgs::msg::typesupport_fastrtps_cpp::_DetectedObstacle__handle;
}
