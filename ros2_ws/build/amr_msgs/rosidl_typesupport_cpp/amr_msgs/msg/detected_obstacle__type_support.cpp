...
static const _DetectedObstacle_type_support_symbol_names_t _DetectedObstacle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, amr_msgs, msg, DetectedObstacle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_msgs, msg, DetectedObstacle)),
  }
};
...
{
  return &::amr_msgs::msg::rosidl_typesupport_cpp::DetectedObstacle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, amr_msgs, msg, DetectedObstacle)() {
  return get_message_type_support_handle<amr_msgs::msg::DetectedObstacle>();
}
