...
bool amr_msgs__msg__choke_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_msgs.msg._choke_request.ChokeRequest", full_classname_dest, 40) == 0);
  }
  amr_msgs__msg__ChokeRequest * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // distance_to_choke
    PyObject * field = PyObject_GetAttrString(_pymsg, "distance_to_choke");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->distance_to_choke = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // reason
...
{
  /* NOTE(esteve): Call constructor of ChokeRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_msgs.msg._choke_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ChokeRequest");
  ...
  {  // distance_to_choke
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->distance_to_choke);
    {
      int rc = PyObject_SetAttrString(_pymessage, "distance_to_choke", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
