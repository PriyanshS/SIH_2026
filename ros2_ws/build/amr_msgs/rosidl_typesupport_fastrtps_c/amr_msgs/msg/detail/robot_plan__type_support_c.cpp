...
#include "amr_msgs/msg/detail/robot_plan__rosidl_typesupport_fastrtps_c.h"
...
using _RobotPlan__ros_msg_type = amr_msgs__msg__RobotPlan;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
bool cdr_serialize_amr_msgs__msg__RobotPlan(
  const amr_msgs__msg__RobotPlan * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
bool cdr_deserialize_amr_msgs__msg__RobotPlan(
  eprosima::fastcdr::Cdr & cdr,
  amr_msgs__msg__RobotPlan * ros_message)
{
  // Field name: robot_id
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
size_t get_serialized_size_amr_msgs__msg__RobotPlan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotPlan__ros_msg_type * ros_message = static_cast<const _RobotPlan__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
size_t max_serialized_size_amr_msgs__msg__RobotPlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_msgs__msg__RobotPlan;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
bool cdr_serialize_key_amr_msgs__msg__RobotPlan(
  const amr_msgs__msg__RobotPlan * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
size_t get_serialized_size_key_amr_msgs__msg__RobotPlan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotPlan__ros_msg_type * ros_message = static_cast<const _RobotPlan__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
size_t max_serialized_size_key_amr_msgs__msg__RobotPlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const amr_msgs__msg__RobotPlan * ros_message = static_cast<const amr_msgs__msg__RobotPlan *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_amr_msgs__msg__RobotPlan(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  amr_msgs__msg__RobotPlan * ros_message = static_cast<amr_msgs__msg__RobotPlan *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_amr_msgs__msg__RobotPlan(cdr, ros_message);
}

static uint32_t _RobotPlan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_msgs__msg__RobotPlan(
...
static size_t _RobotPlan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amr_msgs__msg__RobotPlan(
...
static message_type_support_callbacks_t __callbacks_RobotPlan = {
  "amr_msgs::msg",
  "RobotPlan",
...
static rosidl_message_type_support_t _RobotPlan__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RobotPlan,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_msgs, msg, RobotPlan)() {
  return &_RobotPlan__type_support;
}
